...
/* Definitions for Consumer_Task_1 */
osThreadId_t Consumer_Task_1Handle;
const osThreadAttr_t Consumer_Task_1_attributes = {
  .name = "Consumer_Task_1",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for Consumer_Task_2 */
osThreadId_t Consumer_Task_2Handle;
const osThreadAttr_t Consumer_Task_2_attributes = {
  .name = "Consumer_Task_2",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for Consumer_Task_3 */
osThreadId_t Consumer_Task_3Handle;
const osThreadAttr_t Consumer_Task_3_attributes = {
  .name = "Consumer_Task_3",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for CountingSem1 */
...
/* USER CODE BEGIN Header_Start_Producer_Task */
/**
...
/* USER CODE BEGIN Header_Start_Consumer_Task_1 */
/**
* @brief Function implementing the Consumer_Task_1 thread.
* @param argument: Not used
* @retval None
*/
...
void Start_Consumer_Task_1(void *argument)
{
  ...
  /* USER CODE END Start_Consumer_Task_1 */
}

/* USER CODE BEGIN Header_Start_Consumer_Task_2 */
/**
* @brief Function implementing the Consumer_Task_2 thread.
* @param argument: Not used
* @retval None
*/
...
void Start_Consumer_Task_2(void *argument)
{
  ...
  /* USER CODE END Start_Consumer_Task_2 */
}

/* USER CODE BEGIN Header_Start_Consumer_Task_3 */
/**
* @brief Function implementing the Consumer_Task_3 thread.
* @param argument: Not used
* @retval None
*/
...
void Start_Consumer_Task_3(void *argument)
{
  ...
  /* USER CODE END Start_Consumer_Task_3 */
}
